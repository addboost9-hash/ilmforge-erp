...
function StatusButton({ status, current, onPress }) {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.7}
    >
      <Text style={[styles.statusBtnText, isActive && { color: opt.color, fontWeight: '800' }]}>
        {status}
      </Text>
    </TouchableOpacity>
  );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.controls}>
        ...
        >
          ...
          <Text style={styles.classPickerText}>
            {selectedClass
              ? classes.find((c) => (c._id || c.id) === selectedClass)?.name || 'Selected Class'
              : 'Select Class'}
          </Text>
      ...
      {!selectedClass && (
        <View style={styles.promptBox}>
          ...
          <Text style={styles.promptText}>Select a class to mark attendance</Text>
        </View>
      )}
          ...
          >
            {saveMutation.isPending ? (
              ...
              <>
                ...
                <Text style={styles.saveBtnText}>Save & Notify Parents</Text>
              </>
            )}
          </TouchableOpacity>
        </View>

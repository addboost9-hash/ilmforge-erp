        ...
        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          <div className="card">
            ...
            <button className="btn btn-outline" style={{ width:'100%', justifyContent:'center' }}
              onClick={()=>{ document.documentElement.style.setProperty('--navy',customPrimary); document.documentElement.style.setProperty('--teal',customSecondary); toast.success('Custom theme applied!'); }}>

  ...
  return (
    <div style={{ fontFamily:"'Poppins','Inter',system-ui,sans-serif", background:'#fff', color:'#1F2937' }}>
      ...
      <nav style={{ position:'sticky', top:0, zIndex:100, background:'rgba(255,255,255,0.97)', backdropFilter:'blur(10px)', borderBottom:'1px solid #E5E7EB', padding:'0 5%' }}>
        <div style={{ maxWidth:1200, margin:'0 auto', display:'flex', alignItems:'center', justifyContent:'space-between', height:66 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            <div style={{ width:38,height:38,background:'linear-gradient(135deg,#0F766E,#D97706)',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontSize:19,boxShadow:'0 2px 8px rgba(15,118,110,0.25)' }}>🎓</div>
            <div>
      ...
      <section style={{ background:'linear-gradient(145deg,#0F4C45 0%,#0F766E 55%,#0D9488 100%)', padding:'88px 5% 100px', textAlign:'center', position:'relative', overflow:'hidden' }}>
        {/* Decorative */}
        <div style={{ position:'absolute',width:500,height:500,top:-200,left:-200,background:'rgba(255,255,255,0.04)',borderRadius:'50%',pointerEvents:'none' }}/>
        <div style={{ position:'absolute',width:400,height:400,bottom:-150,right:-150,background:'rgba(217,119,6,0.07)',borderRadius:'50%',pointerEvents:'none' }}/>
        ...
        <div style={{ position:'relative', maxWidth:800, margin:'0 auto' }}>
          ...
          <div style={{ display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap' }}>
            <Link to="/register"
              style={{ background:'#D97706',color:'#fff',padding:'14px 32px',borderRadius:10,fontSize:15.5,fontWeight:800,textDecoration:'none',display:'flex',alignItems:'center',gap:8,boxShadow:'0 4px 20px rgba(217,119,6,0.4)',transition:'all .14s' }}
      ...
      <section style={{ background:'linear-gradient(145deg,#0F4C45,#0F766E,#0D9488)', padding:'80px 5%', textAlign:'center' }}>
        <div style={{ maxWidth:640, margin:'0 auto' }}>
          ...
          <div style={{ marginTop:20, fontSize:12, color:'rgba(255,255,255,0.4)' }}>
            Already registered?{' '}
            <Link to="/login" style={{ color:'rgba(255,255,255,0.6)', fontWeight:600, textDecoration:'none' }}>Sign in to your portal →</Link>
          </div>
        </div>
      </section>

...
export default function PortalManagementPage() {
  ...
  const resetPw = useMutation({
    mutationFn: ({ userId, password }) => api.post('/auth/change-password', { userId, newPassword: password }).catch(() =>
      api.put('/auth/reset-staff-password', { userId, newPassword: password })
    ),
